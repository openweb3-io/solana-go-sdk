	...
	client_test.TestAll(
		...
		[]client_test.Param{
			...
			},
			{
				...
				F: func(url string) (any, error) {
					c := NewRpcClient(url)
					return c.SendTransaction(context.Background(), "")
				},
				ExpectedValue: JsonRpcResponse[string]{
					JsonRpc: "2.0",
					Id:      1,
			...
			},
			{
				...
				F: func(url string) (any, error) {
					c := NewRpcClient(url)
					return c.SendTransaction(context.Background(), "")
				},
				ExpectedValue: JsonRpcResponse[string]{
					JsonRpc: "2.0",
					Id:      1,
			...
			},
			{
				...
				F: func(url string) (any, error) {
					c := NewRpcClient(url)
					return c.SendTransaction(context.Background(), "KAmmQBoPnTWMnMCsoa8chJJN6R2EdP2X9i48wDayjdg6WBpaj88yYQ655LNpXiSa1pPVsp6ynCBaaQeSi1ZKQKuziYss4LgmfjuWhQyRyzZfkfM5W7AsQCG1XTNWbKmXzXpNPLXLLx3tTN49n3Q7eq7g5kJnsJZNJJKnYgHSbwEQVcTfqecC6P3V6CtMEeCjM9PzRKnaUXc5seW6gcMDhgTfgPbacVjkZsrUh6mwC84amEJrwioYcYqyh")
				},
				ExpectedValue: JsonRpcResponse[string]{
					JsonRpc: "2.0",
					Id:      1,
